...
# Install rust target toolchains for the default toolchain
...
BINDGEN_EXTRA_CLANG_ARGS="--target=aarch64-apple-ios-simulator" cargo build --release --features uniffi --target aarch64-apple-ios-sim || exit 1
